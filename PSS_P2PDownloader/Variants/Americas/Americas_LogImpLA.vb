...
#Region "Functions Grid 1"
    ...
    Private Sub Fill_Matrix1()
        ...
        Try
            ...
            MBS1.DataSource = SQL_F.GetDataTable(CS, "Select * From View_Americas_LogImpLA")
            ...
            For Each C In dgv_Matrix1.Columns
                If C.Name <> "Flag" And C.Name <> "Description" And C.Name <> "Owner" And C.Name <> "Enabled" And C.Name <> "Pending_Approval" Then
                    C.ReadOnly = True
                End If
            Next
            ...
            dgv_Matrix1.Columns("Spend").HeaderCell.Style = Key_Column
    ...
    Private Sub dgv_Matrix1_RowLeave(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Matrix1.RowLeave
        ...
        Try
            If dgv_Matrix1.IsCurrentRowDirty Then
                ...
                Dim Spend As String = dgv_Matrix1.CurrentRow.Cells("Spend").Value

                Dim DT As DataTable = SQL_F.GetSQLTable(CS, "Var_Americas_LogImpLA", "(Plant='" & Plant & "') AND (SAP_Box='" & SAP_Box & "') AND (POrg=" & POrg & ") AND (Spend='" & Spend & "')")
                If DT.Rows.Count = 1 Then
                    ...
                    Dim Update As String = "Update Var_Americas_LogImpLA Set " & _
                    ...
                    "Where (Plant='" & Plant & "') AND (SAP_Box='" & SAP_Box & "') AND (POrg=" & POrg & ") AND (Spend='" & Spend & "')"
    ...
    Private Sub Delete_Email_Date(ByRef R As DataRow)
        Try
            Dim Update As String = "Update Var_Americas_LogImpLA Set Email_Date=Null Where (Plant='" & R("Plant") & "') AND (SAP_Box='" & R("SAP_Box") & "') AND (POrg=" & R("POrg") & ") AND (Spend='" & R("Spend") & "')"
    ...
    Private Sub Delete_Combination(ByRef R As DataRow)
        Try
            Dim Delete As String = "Delete From Var_Americas_LogImpLA Where (Plant='" & R("Plant") & "') AND (SAP_Box='" & R("SAP_Box") & "') AND (POrg=" & R("POrg") & ") AND (Spend='" & R("Spend") & "')"
...
#Region "Buttons"
    ...
    Private Sub btn_New_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_New.Click
        ...
        Dim FRM_Small As New Americas_LogImpLA_NewRow
        ...
        Try
            While Not FRM_Small.Result
                ...
                Dim Insert As String = "Insert Into Var_Americas_LogImpLA(Plant,SAP_Box,POrg,Spend,Suggested_Owner,Change_Type,Enabled,Owner,Created_Date,Created_By,Updated_Date,Updated_By) Values"
                Insert += "("
                Insert += "'" & Plant.Trim & "',"
                Insert += "'" & SAP_Box.Trim & "',"
                Insert += POrg.Trim & ","
    ...
    Private Sub btn_Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Delete.Click
        Try
            ...
            DT_ToBeDeleted = SQL_F.GetDataTable(CS, "Select * From View_Americas_LogImpLA Where (Flag=1)")
            ...
            If DT_ToBeDeleted.Rows.Count > 0 Then
                If SF.ShowConfirmationMessage("Would you like to Delete: [" & DT_ToBeDeleted.Rows.Count & "] Combinations? ", Project_Name) Then
                    For Each R As DataRow In DT_ToBeDeleted.Rows
                        Dim Delete As String = "Update Var_Americas_LogImpLA Set Change_Type=3 Wher (Plant='" & R("Plant") & "') AND (SAP_Box='" & R("SAP_Box") & "') AND (POrg=" & R("POrg") & ") AND (Spend='" & R("Spend") & "')"
                        Dim Exc As String = SQL_F.SQL_Execute_NQ(CS, Delete)
                        If Exc <> Nothing Then
    ...
    Private Sub btn_Export_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Export.Click
        If SF.ExportVariantToExcel("LogImpLA", My.Computer.FileSystem.SpecialDirectories.Desktop & "\Variant - Americas LogImpLA (" & Date.Now.Month & "-" & Date.Now.Day & "-" & Date.Now.Year & ").xlsx") Then
