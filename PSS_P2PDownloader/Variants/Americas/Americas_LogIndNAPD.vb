...
#Region "Functions Grid 1"
    ...
    Private Sub Fill_Matrix1()
        ...
        Try
            ...
            MBS1.DataSource = SQL_F.GetDataTable(CS, "Select * From View_Americas_LogIndNAPD")
            ...
            For Each C In dgv_Matrix1.Columns
                If C.Name <> "Flag" And C.Name <> "Description" And C.Name <> "Owner" And C.Name <> "Enabled" And C.Name <> "Infosys_ReqToPO" And C.Name <> "Infosys_OpenOrders" And C.Name <> "Pending_Approval" Then
                    C.ReadOnly = True
                End If
            Next
            ...
            'Key Columns
            dgv_Matrix1.Columns("Material_Group").HeaderCell.Style = Key_Column
    ...
    Private Sub dgv_Matrix1_RowLeave(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Matrix1.RowLeave
        ...
        Try
            If dgv_Matrix1.IsCurrentRowDirty Then
                ...
                Dim R As DataRow
                Dim Material_Group As String = dgv_Matrix1.CurrentRow.Cells("Material_Group").Value
                Dim SAP_Box As String = dgv_Matrix1.CurrentRow.Cells("SAP_Box").Value

                Dim DT As DataTable = SQL_F.GetSQLTable(CS, "Var_Americas_LogIndNAPD", "(Material_Group='" & Material_Group & "') AND (SAP_Box='" & SAP_Box & "')")
                If DT.Rows.Count = 1 Then
                    ...
                    Dim Update As String = "Update Var_Americas_LogIndNAPD Set " & _
                    ...
                    "Where (Material_Group='" & Material_Group & "') AND (SAP_Box='" & SAP_Box & "') "
    ...
    Private Sub Delete_Email_Date(ByRef R As DataRow)
        Try
            Dim Update As String = "Update Var_Americas_LogIndNAPD Set Email_Date=Null Where (Material_Group='" & R("Material_Group") & "') AND (SAP_Box='" & R("SAP_Box") & "')"
    ...
    Private Sub Delete_Combination(ByRef R As DataRow)
        Try
            Dim Delete As String = "Delete From Var_Americas_LogIndNAPD Where (Material_Group='" & R("Material_Group") & "') AND (SAP_Box='" & R("SAP_Box") & "')"
...
#Region "Functions Tool Bar"
    ...
    Private Sub FlagCheck(ByVal Column As String, ByVal Value As Integer)
        ...
        Try
            ...
            Dim Material_Group As String = Nothing
...
#Region "Buttons"
    ...
    Private Sub btn_New_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_New.Click
        ...
        Dim FRM_Small As New Americas_LogIndNAPD_NewRow
            ...
            While Not FRM_Small.Result
                If (FRM_Small.ShowDialog() = Windows.Forms.DialogResult.OK) Then
                    If FRM_Small.Result Then
                        ...
                        Material_Group = FRM_Small.Material_Group_
                ...
                Dim Insert As String = "Insert Into Var_Americas_LogIndNAPD(Material_Group,SAP_Box,Suggested_Owner,Change_Type,Enabled,Owner,Infosys_ReqToPO,Infosys_OpenOrders,Created_Date,Created_By,Updated_Date,Updated_By) Values"
                Insert += "("
                Insert += "'" & Material_Group.Trim & "',"
                Insert += "'" & SAP_Box.Trim & "',"
                ...
                If Exc <> Nothing Then
                    If Exc.Contains("Violation") Then
                        MsgBox("This Combination Already exists [Material_Group,SAP_Box]", MsgBoxStyle.Information, Project_Name)
                    Else
    ...
    Private Sub btn_Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Delete.Click
        Try
            ...
            DT_ToBeDeleted = SQL_F.GetDataTable(CS, "Select * From View_Americas_LogIndNAPD Where (Flag=1)")
            ...
            If DT_ToBeDeleted.Rows.Count > 0 Then
                If SF.ShowConfirmationMessage("Would you like to Delete: [" & DT_ToBeDeleted.Rows.Count & "] Combinations? ", Project_Name) Then
                    For Each R As DataRow In DT_ToBeDeleted.Rows
                        Dim Delete As String = "Update Var_Americas_LogIndNAPD Set Change_Type=3 Where (Material_Group='" & R("Material_Group") & "') AND (SAP_Box='" & R("SAP_Box") & "')"
                        Dim Exc As String = SQL_F.SQL_Execute_NQ(CS, Delete)
                        If Exc <> Nothing Then
    ...
    Private Sub btn_Export_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Export.Click
        If SF.ExportVariantToExcel("LogIndNAPD", My.Computer.FileSystem.SpecialDirectories.Desktop & "\Variant - Americas LogIndNAPD (" & Date.Now.Month & "-" & Date.Now.Day & "-" & Date.Now.Year & ").xlsx") Then
