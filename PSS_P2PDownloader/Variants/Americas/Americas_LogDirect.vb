...
#Region "Functions Grid 1"
    ...
    Private Sub Fill_Matrix1()
        ...
        Try
            ...
            MBS1.DataSource = SQL_F.GetDataTable(CS, "Select * From View_Americas_LogDirect")
            ...
            For Each C In dgv_Matrix1.Columns
                If C.Name <> "Flag" And C.Name <> "Description" And C.Name <> "Owner" And C.Name <> "Enabled" And C.Name <> "Vendor_Name" And C.Name <> "Pending_Approval" Then
                    C.ReadOnly = True
                End If
            Next
            ...
            dgv_Matrix1.Columns("Vendor").HeaderCell.Style = Key_Column
            ...
            dgv_Matrix1.Columns("Vendor_Name").HeaderCell.Style = Editable_Column
    ...
    Private Sub dgv_Matrix1_RowLeave(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Matrix1.RowLeave
        ...
        Try
            If dgv_Matrix1.IsCurrentRowDirty Then
                ...
                Dim R As DataRow
                Dim Vendor As String = dgv_Matrix1.CurrentRow.Cells("Vendor").Value
                Dim SAP_Box As String = dgv_Matrix1.CurrentRow.Cells("SAP_Box").Value

                Dim DT As DataTable = SQL_F.GetSQLTable(CS, "Var_Americas_LogDirect", "(Vendor=" & Vendor & ") AND (SAP_Box='" & SAP_Box & "')")
                If DT.Rows.Count = 1 Then
                    ...
                    R("Vendor_Name") = dgv_Matrix1.CurrentRow.Cells("Vendor_Name").Value
                    ...
                    Dim Update As String = "Update Var_Americas_LogDirect Set " & _
                    "Flag=" & SF.BooleanConvertion(R("Flag")) & ", " & _
                    "Description='" & R("Description") & "'," & _
                    "Owner='" & R("Owner") & "'," & _
                    "Enabled='" & R("Enabled") & "'," & _
                    "Vendor_Name='" & R("Vendor_Name") & "'," & _
                    ...
                    "Where (Vendor=" & Vendor & ") AND (SAP_Box ='" & SAP_Box & "')"
    ...
    Private Sub Delete_Email_Date(ByRef R As DataRow)
        Try
            Dim Update As String = "Update Var_Americas_LogDirect Set Email_Date=Null Where (Vendor=" & R("Vendor") & ") AND (SAP_Box ='" & R("SAP_Box") & "')"
    ...
    Private Sub Delete_Combination(ByRef R As DataRow)
        Try
            Dim Delete As String = "Delete From Var_Americas_LogDirect Where (Vendor=" & R("Vendor") & ") AND (SAP_Box ='" & R("SAP_Box") & "')"
...
#Region "Buttons"
    ...
    Private Sub btn_New_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_New.Click
        ...
        Dim FRM_Small As New Americas_LogDirect_NewRow
            ...
            While Not FRM_Small.Result
                If (FRM_Small.ShowDialog() = Windows.Forms.DialogResult.OK) Then
                    If FRM_Small.Result Then
                        ...
                        Vendor = FRM_Small.Vendor_
                        Vendor_Name = FRM_Small.Vendor_Name_
                ...
                Dim Insert As String = "Insert Into Var_Americas_LogDirect(SAP_Box,Vendor,Vendor_Name,Suggested_Owner,Change_Type,Enabled,Owner,Created_Date,Created_By,Updated_Date,Updated_By) Values"
                Insert += "("
                Insert += "'" & SAP_Box & "',"
                Insert += Vendor.Trim & ","
                Insert += "'" & Vendor_Name & "',"
                ...
                If Exc <> Nothing Then
                    If Exc.Contains("Violation") Then
                        MsgBox("This Combination Already exists [Vendor]", MsgBoxStyle.Information, Project_Name)
                    Else
    ...
    Private Sub btn_Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Delete.Click
        Try
            ...
            DT_ToBeDeleted = SQL_F.GetDataTable(CS, "Select * From View_Americas_LogDirect Where (Flag=1)")
            ...
            If DT_ToBeDeleted.Rows.Count > 0 Then
                If SF.ShowConfirmationMessage("Would you like to Delete: [" & DT_ToBeDeleted.Rows.Count & "] Combinations? ", Project_Name) Then
                    For Each R As DataRow In DT_ToBeDeleted.Rows
                        Dim Delete As String = "Update Var_Americas_LogDirect Set Change_Type=3 Where (Vendor=" & R("Vendor") & ") AND (SAP_Box = '" & R("SAP_Box") & "')"
                        Dim Exc As String = SQL_F.SQL_Execute_NQ(CS, Delete)
                        If Exc <> Nothing Then
    ...
    Private Sub btn_Export_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Export.Click
        If SF.ExportVariantToExcel("LogDirect", My.Computer.FileSystem.SpecialDirectories.Desktop & "\Variant - Americas LogDirect (" & Date.Now.Month & "-" & Date.Now.Day & "-" & Date.Now.Year & ").xlsx") Then
