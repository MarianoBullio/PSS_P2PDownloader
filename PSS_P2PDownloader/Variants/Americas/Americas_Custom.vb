...
#Region "Functions Grid 1"
    ...
    Private Sub Fill_Matrix1()
        ...
        Try
            ...
            MBS1.DataSource = SQL_F.GetDataTable(CS, "Select * From View_Americas_Custom")
    ...
    Private Sub dgv_Matrix1_RowLeave(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles dgv_Matrix1.RowLeave
        ...
        Try
            If dgv_Matrix1.IsCurrentRowDirty Then
                ...
                Dim DT As DataTable = SQL_F.GetSQLTable(CS, "Var_Americas_Custom", "(SAP_Box='" & SAP_Box & "') AND (POrg=" & POrg & ") AND (Variant=" & Variant_ & ")")
                If DT.Rows.Count = 1 Then
                    ...
                    Dim Update As String = "Update Var_Americas_Custom Set " & _
                    ...
                    "Where (SAP_Box='" & SAP_Box & "') AND (POrg=" & POrg & ") AND (Variant=" & Variant_ & ")"
    ...
    Private Sub Delete_Email_Date(ByRef R As DataRow)
        Try
            Dim Update As String = "Update Var_Americas_Custom Set Email_Date=Null Where (SAP_Box='" & R("SAP_Box") & "') AND (POrg=" & R("POrg") & ") AND (Variant=" & R("Variant") & ")"
    ...
    Private Sub Delete_Combination(ByRef R As DataRow)
        Try
            Dim Delete As String = "Delete From Var_Americas_Custom Where (SAP_Box='" & R("SAP_Box") & "') AND (POrg=" & R("POrg") & ") AND (Variant=" & R("Variant") & ")"
...
#Region "Buttons"
    ...
    Private Sub btn_New_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_New.Click
        ...
        Dim FRM_Small As New Americas_Custom_NewRow
        ...
        Try
            While Not FRM_Small.Result
                ...
                Dim Insert As String = "Insert Into Var_Americas_Custom(SAP_Box,POrg,Variant,Suggested_Owner,Change_Type,Enabled,Owner,Infosys_ReqToPO,Infosys_OpenOrders,Created_Date,Created_By,Updated_Date,Updated_By) Values"
                Insert += "("
                Insert += "'" & SAP_Box.Trim & "',"
                Insert += POrg.Trim & ","
    ...
    Private Sub btn_Delete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Delete.Click
        Try
            ...
            DT_ToBeDeleted = SQL_F.GetDataTable(CS, "Select * From View_Americas_Custom Where (Flag=1)")
            ...
            If DT_ToBeDeleted.Rows.Count > 0 Then
                If SF.ShowConfirmationMessage("Would you like to Delete: [" & DT_ToBeDeleted.Rows.Count & "] Combinations? ", Project_Name) Then
                    For Each R As DataRow In DT_ToBeDeleted.Rows
                        Dim Delete As String = "Update Var_Americas_Custom Set Change_Type=3 Where  (SAP_Box='" & R("SAP_Box") & "') AND (POrg=" & R("POrg") & ") AND (Variant=" & R("Variant") & ")"
                        Dim Exc As String = SQL_F.SQL_Execute_NQ(CS, Delete)
                        If Exc <> Nothing Then
    ...
    Private Sub btn_Export_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Export.Click
        If SF.ExportVariantToExcel("Custom", My.Computer.FileSystem.SpecialDirectories.Desktop & "\Variant - Americas Custom (" & Date.Now.Month & "-" & Date.Now.Day & "-" & Date.Now.Year & ").xlsx") Then
