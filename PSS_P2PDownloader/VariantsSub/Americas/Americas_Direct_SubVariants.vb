...
Public Class Americas_Direct_SubVariants
    ...
    Private Sub Americas_Direct_SubVariants_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

        Try
            SF.Load_ComboBox(List_Variant, CS, "SELECT Variant, Description FROM Var_Americas_Direct_Variants Order By Description Asc")
    ...
    Private Sub Fill_DGV(ByVal Variant_Number As Object)
        Try
            ...
            MBS.DataSource = SQL_F.GetDataTable(CS, "Select * From Var_Americas_Direct_Var" & Variant_Number)
...
#Region "Functions Tool Bar"
        ...
        Try
            ...
            Select Case Variant_Number
                ...
                Case "01"
                    ...
                    Vendor = InputBox("Vendor Code [Required Length 8]:", Project_Name, "")

                    Dim Vendor_Name As String
                    Vendor_Name = InputBox("Vendor Name [Required Length <=200]:", Project_Name, "")

                    Dim Scope As String
                    Scope = InputBox("Scope [Others/Logistics]:", Project_Name, "")

                    If Vendor = "" Then
                        Exit Sub
                    End If

                    If Vendor.Length <> 8 Then
                        MsgBox("Error: Review 'Vendor Code' Value [Length must be = 8]", MsgBoxStyle.Exclamation, Project_Name)
                    Else
                        Dim Insert As String = "Insert Into Var_Americas_Direct_Var" & Variant_Number & " Values (" & Vendor & ",'" & Vendor_Name & "','" & Scope & "')"
                        Dim Exc As String = SQL_F.SQL_Execute_NQ(CS, Insert)
                        If Exc <> Nothing Then
                            If Exc.Contains("Violation") Then
                                MsgBox("This Combination Already exists [Vendor Code]", MsgBoxStyle.Information, Project_Name)
                            Else
            ...
            If SF.ShowConfirmationMessage() Then
                ...
                Select Case Variant_Number
                    ...
                    Case "01"
                        ...
                        Dim Vendor As String
                        Vendor = dgv_Main.CurrentRow.Cells("Vendor").Value

                        Dim Delete As String = "Delete From Var_Americas_Direct_Var" & Variant_Number & " Where(Vendor=" & Vendor & ")"
                        Dim Exc As String = SQL_F.SQL_Execute_NQ(CS, Delete)
                        If Exc <> Nothing Then
                            MsgBox(Standart_MessageError, MsgBoxStyle.Exclamation, Project_Name)
                        Else
                            Fill_DGV(List_Variant.SelectedValue)
                            MsgBox("Item has been Deleted [" & Vendor & "]", MsgBoxStyle.Information, Project_Name)
                        End If
    ...
    Private Sub btn_Copy_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btn_Copy.Click
        Try
            ...
            ''If Variant_Number <> "01" Then
            SQL_F.TableToClipboard(SQL_F.GetDataTable(CS, "Select * From Var_Americas_Direct_Var" & Variant_Number))
            ''End If
